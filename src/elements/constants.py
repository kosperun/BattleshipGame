...
# Rectangular areas for grids, messages, buttons and ship counts
...
X_OFFSET_FOR_HUMAN_SHIPS_COUNT = LEFT_MARGIN + 27 * BLOCK_SIZE
X_OFFSET_FOR_COMPUTER_SHIPS_COUNT = LEFT_MARGIN - 4 * BLOCK_SIZE
Y_OFFSET_FOR_SHIPS_COUNT = UPPER_MARGIN + 2 * BLOCK_SIZE
